...
export const ISSUES = [
    // --- CRITICAL / EMERGENCY ALERTS (Top Priority) ---
    {
        ...
        assignedZone: 'North', status: 'pending',
        priority: 'High',
        riskLevel: 'Crisis',
    ...
    },
    {
        ...
        assignedZone: 'South', status: 'pending',
        priority: 'High',
        riskLevel: 'Critical',
    ...
    },
    {
        ...
        assignedZone: 'East', status: 'in-progress',
        priority: 'High',
        riskLevel: 'Critical',
    ...
    // --- RECENT CITIZEN REPORTS (Standard) ---
    {
        ...
        assignedZone: 'West', status: 'pending',
        priority: 'Medium',
        riskLevel: 'Moderate',
    ...
    },
    {
        ...
        assignedZone: 'Central', status: 'pending',
        priority: 'Medium',
        riskLevel: 'Moderate',
        title: 'Deep Pothole',
    ...
    // --- AI DETECTED FAKES / SPAM ---
    {
        ...
        assignedZone: 'South', status: 'rejected',
        priority: 'Low',
        riskLevel: 'Low',
    ...
    },
    {
        ...
        assignedZone: 'East', status: 'rejected',
        priority: 'Medium',
        riskLevel: 'Low',
        title: 'Sinkhole',
    ...
    // --- IOT ALERTS (System Generated) ---
    {
        ...
        assignedZone: 'West', status: 'in-progress',
        priority: 'Medium',
        riskLevel: 'Moderate',
    ...
    },
    {
        ...
        assignedZone: 'Central', status: 'normal',
        priority: 'Low',
        riskLevel: 'Low',
    ...
    // --- RESOLVED / HISTORY ---
    {
        ...
        assignedZone: 'North', status: 'resolved',
        priority: 'Low',
        riskLevel: 'Low',
        title: 'Minor Leakage',
    ...
    },
    {
        ...
        assignedZone: 'South', status: 'completed',
        priority: 'Low',
        riskLevel: 'Low',
    ...
    // --- SCHEDULED MAINTENANCE (Calendar) ---
    {
        ...
        assignedZone: 'East', status: 'pending',
        priority: 'Medium',
    ...
    },
    {
        ...
        assignedZone: 'Central', status: 'in-progress',
        priority: 'Medium',
    ...
    },
    {
        ...
        assignedZone: 'Central', status: 'rejected',
        priority: 'Low',
        riskLevel: 'Low',
...
export const SENSORS = [
    // Water Supply Sensors (Near Issue 1)
    {
        ...
        unit: 'bar',
        range: { min: 15, max: 25 },
        assignedZone: 'East', status: 'critical',
        trend: 'falling',
    ...
    },
    {
        ...
        assignedZone: 'West', status: 'warning',
        trend: 'rising',
    ...
    // Lighting Sensors (Near Issue 2)
    {
        ...
        assignedZone: 'North', status: 'warning',
        trend: 'unstable',
    ...
    // Power Sensors
    {
        ...
        unit: '%',
        range: { min: 0, max: 90 },
        assignedZone: 'South', status: 'warning',
        trend: 'rising',
    ...
    // Roads Sensors
    {
        ...
        unit: 'g',
        range: { min: 0, max: 0.5 },
        assignedZone: 'East', status: 'normal',
        trend: 'stable',
    ...
    // Environmental
    {
        ...
        value: 'Low',
        unit: 'Risk',
        assignedZone: 'West', status: 'normal',
        trend: 'stable',
